...
.Schritte
. https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-creating-connectors-aws.html["Installieren Sie einen Anschluss"^] In dem AWS Konto, wo Sie Ihre Amazon S3 Buckets anzeigen möchten.
