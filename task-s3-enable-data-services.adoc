...
+
https://docs.netapp.com/us-en/cloud-manager-sync/concept-cloud-sync.html["Weitere Informationen zum BlueXP Kopier- und Synchronisierungsservice"^].
...
+
https://docs.netapp.com/us-en/cloud-manager-data-sense/task-scanning-s3.html["Erfahren Sie mehr über den BlueXP Klassifizierungsservice"^].
